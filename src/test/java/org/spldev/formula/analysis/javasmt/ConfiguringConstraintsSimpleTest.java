...
public class ConfiguringConstraintsSimpleTest {
    ...
    protected void assertSolutionCountSum(long threshold, String attribute, long expected){
        ...
        JavaSmtSolver solver = new JavaSmtSolver(new And(model, condition), SolverContextFactory.Solvers.SMTINTERPOL);
    ...
    public void testProduct() {
        assertSolutionCountProduct(0.9, "Ausfall", 7);
        assertSolutionCountProduct(1.0, "Ausfall", 8);
        assertSolutionCountProduct(1, "protocolDouble", 0);
        assertSolutionCountProduct(0.5, "protocolDouble", 0);
    }
